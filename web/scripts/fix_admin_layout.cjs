            ...
            <section data-zone="admin" className="flex flex-1 flex-col">
              <div className="mx-auto flex max-w-xl flex-col gap-6 text-center">
                ...
                <div>
                  ...
                  <p className="mt-1 text-ink-600">The admin panel is not yet available.</p>
                  <p className="mt-1 text-sm text-ink-500">
                    This can mean Supabase is not configured, or your account does not have admin privileges.
                  </p>
                </div>
                <div className="rounded-xl border border-ink-200 bg-surface p-5 text-left text-sm text-ink-600">
                  <p className="font-medium text-ink-900">If you are an administrator:</p>
                  <ul className="mt-2 space-y-1.5 list-disc list-inside">
                    <li>Make sure environment variables are configured.</li>
                  </ul>
                </div>
                <p className="text-sm text-ink-500">If you believe you should have access, contact the platform administrator.</p>
              </div>
            </section>
          </main>
        </div>

  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-10 px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        {HAS_WHATSAPP_SUPPORT ? (
        <Card tone="raised" className="flex flex-col gap-4 p-6">
          <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-success-500/15 text-success-300">
          ...
          >
            ...
            Chat on WhatsApp: {SUPPORT_WHATSAPP_DISPLAY}
          </a>
        </Card>
        ) : null}
      </div>
      ...
      <Card tone="muted" className="p-6">
        ...
        <ul className="mt-3 space-y-2 text-sm text-ink-300">
          <li>· Browse our <Link href="/safety" className="text-brand-300 hover:underline">Safety centre</Link> for common questions.</li>
          <li>· Read our <Link href="/legal/terms" className="text-brand-300 hover:underline">Terms of Service</Link> and <Link href="/legal/privacy" className="text-brand-300 hover:underline">Privacy Policy</Link>.</li>
          <li>· Email us at <a href={`mailto:${SUPPORT_EMAIL}`} className="text-brand-300 hover:underline">{SUPPORT_EMAIL}</a> for account or billing issues.</li>
        </ul>
      </Card>
    </div>
  );

...
export default function FeedbackPage() {
  ...
  return <div className="mx-auto flex w-full max-w-2xl flex-col gap-8">
    ...
    <Card className="flex flex-col gap-4">
      {sent ? <div role="status" className="rounded-xl border border-emerald-400/30 bg-emerald-400/10 p-5 text-sm text-emerald-200">Thank you — your feedback was received.</div> : <>

...
export default async function LandingPage() {
  ...
  const [events, testimonialItems] = await Promise.all([
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-950 via-purple-900 to-slate-950 text-white">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Link
              ...
              className="group flex h-full flex-col rounded-2xl border border-white/10 bg-white/5 p-6 transition hover:-translate-y-1 hover:border-orange-400/40 hover:bg-white/10 hover:shadow-xl hover:shadow-purple-900/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400 active:translate-y-0 active:bg-white/15"
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-purple-500 to-purple-700 text-white transition group-hover:scale-110">
            ...
            <Link
              ...
              className="group flex h-full flex-col rounded-2xl border border-white/10 bg-white/5 p-6 transition hover:-translate-y-1 hover:border-purple-400/40 hover:bg-white/10 hover:shadow-xl hover:shadow-purple-900/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-400 active:translate-y-0 active:bg-white/15"
            >
            ...
            <Link
              ...
              className="group flex h-full flex-col rounded-2xl border border-white/10 bg-white/5 p-6 transition hover:-translate-y-1 hover:border-orange-400/40 hover:bg-white/10 hover:shadow-xl hover:shadow-purple-900/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400 active:translate-y-0 active:bg-white/15"
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-orange-500 to-purple-600 text-white transition group-hover:scale-110">
                <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
      ...
      <section className="bg-gradient-to-br from-purple-950 via-purple-900 to-slate-950 py-20 sm:py-24" aria-labelledby="insights-heading">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {INSIGHT_ARTICLES.map((article) => (
              ...
              >
                <span className="inline-block rounded-md bg-gradient-to-r from-purple-500/20 to-purple-500/10 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-purple-200">
                  {article.eyebrow}
                </span>
       ...
       <section className="bg-gradient-to-br from-purple-950 via-purple-900 to-slate-950 py-20 sm:py-24" aria-labelledby="how-heading">
         <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
           ...
           <div className="mt-16">
             ...
             <div className="grid gap-6 sm:grid-cols-3">
               {/* Step 1 */}
               <div className="group flex flex-col rounded-2xl border border-white/10 bg-white/5 p-6 transition hover:-translate-y-1 hover:border-orange-400/40 hover:bg-white/10 hover:shadow-xl hover:shadow-purple-900/40">
                 <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-orange-500 to-purple-600 text-white transition group-hover:scale-110">
               ...
               {/* Step 3 */}
               <div className="group flex flex-col rounded-2xl border border-white/10 bg-white/5 p-6 transition hover:-translate-y-1 hover:border-orange-400/40 hover:bg-white/10 hover:shadow-xl hover:shadow-purple-900/40">
                 <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-orange-500 to-orange-600 text-white transition group-hover:scale-110">
           ...
           <div className="mt-16">
             ...
             <div className="grid gap-4 sm:grid-cols-3">
               {/* Verified Profiles */}
               <div className="group flex flex-col rounded-xl border border-white/10 bg-white/5 p-6 transition hover:-translate-y-1 hover:border-purple-400/40 hover:bg-white/10">
               ...
               <div className="group flex flex-col rounded-xl border border-white/10 bg-white/5 p-6 transition hover:-translate-y-1 hover:border-purple-400/40 hover:bg-white/10">
                 <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-orange-500 to-orange-600 text-white">
      ...
      <section className="bg-gradient-to-br from-purple-950 via-purple-900 to-slate-950 py-20 sm:py-24" aria-labelledby="events-heading">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
      ...
      <section className="bg-gradient-to-br from-purple-950 via-purple-900 to-slate-950 py-20 sm:py-24" aria-labelledby="stories-heading">

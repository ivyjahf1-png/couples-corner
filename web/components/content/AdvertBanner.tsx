...
export async function AdvertBanner() {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-white/15 bg-white/5 shadow-2xl shadow-purple-950/50 backdrop-blur-sm">
      {/* Media area */}
      <div className="relative aspect-[21/9] w-full overflow-hidden">
        ...
        {/* "Featured" badge */}
        <span className="absolute left-4 top-4 inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-orange-500 to-orange-600 px-3 py-1 text-xs font-semibold text-white shadow-lg">
      ...
      <div className="absolute inset-x-0 bottom-0 flex flex-col gap-3 p-6 sm:p-8">
        <h2 className="max-w-xl text-2xl font-bold tracking-tight text-white drop-shadow-md sm:text-3xl">
          {hero.title}
        </h2>
        {hero.description ? (
        ...
        {hero.destinationUrl ? (
          isExternal ? (
            <a
              ...
              className="inline-flex w-fit items-center gap-2 rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg transition hover:from-orange-400 hover:to-orange-500"
            >

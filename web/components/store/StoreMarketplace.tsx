...
const categories = ["Frames", "Vehicles", "Room Entry", "Bubbles", "Room Card", "Theme"] as const;
...
const items: Record<Category, { name: string; price: number; duration: string; icon: string }[]> = {
  ...
  "Room Entry": [{ name: "Royal Entrance", price: 18000, duration: "30Days", icon: "✨" }, { name: "Starlight", price: 7500, duration: "7Days", icon: "🌟" }],

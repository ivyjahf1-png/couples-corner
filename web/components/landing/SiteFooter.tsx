...
export function SiteFooter() {
  return (
    <footer className="border-t border-ink-700 bg-surface-muted">
      <div className="mx-auto max-w-7xl px-5 py-12 sm:px-6 lg:px-10">
              ...
              <ul className="flex flex-col gap-2">
                {col.links.map((link) => (
                  <li key={link.href}>
                    <a
                      href={link.href}
                      className="text-ink-300 transition hover:text-brand-300 hover:underline"
                    >
                      {link.label}
                    </a>
                  </li>
            ...
            <ul className="flex flex-col gap-2">
              <li>
                <a
                  ...
                  className="inline-flex items-center gap-2 text-ink-300 transition hover:text-brand-300 hover:underline"
                >
        ...
        <p className="mt-10 border-t border-ink-700 pt-5 text-center text-xs leading-5 text-ink-400">
          © {COPYRIGHT_YEAR} Couples Corner. Built with care for every
          couple · Support:{" "}
          <a className="text-brand-300 hover:underline" href={`mailto:${SUPPORT_EMAIL}`}>
            {SUPPORT_EMAIL}
          </a>
        </p>
      </div>
